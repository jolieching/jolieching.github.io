...
The responses to this question reflects the success of the asker's question. The 40+ responses were complete with breakdowns of the the code, suggestions, diagrams and example code.
